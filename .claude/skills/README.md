...
Advanced, structured skills for Claude Code following Anthropic's Agent Skills
standard (December 2025).

## Overview

Agent Skills are more sophisticated than regular commands (`.claude/commands/`),
providing:

- **Structured architecture**: SKILL.md + scripts + templates + configs
- **Cross-platform compatibility**: Can be used across different Claude Code
  environments
...
**Documentation**: [README](code-quality-suite/README.md) |
[SKILL](code-quality-suite/SKILL.md)
...
**Documentation**: [README](technical-blog-generator/README.md) |
[SKILL](technical-blog-generator/SKILL.md)
...
**Documentation**: [README](aws-cost-optimizer/README.md) |
[SKILL](aws-cost-optimizer/SKILL.md)
...
**Documentation**: [README](serverless-optimizer/README.md) |
[SKILL](serverless-optimizer/SKILL.md)
...
**Documentation**: [README](database-manager/README.md) |
[SKILL](database-manager/SKILL.md)
...
**Documentation**: [README](spec-driven-development/README.md) |
...
These skills have complete SKILL.md specifications but scripts are not yet
implemented:

1. **aws-deploy-automation** - AWS deployment automation with
...
4. **e2e-test-generator** - E2E test generation from user flows
   (Playwright/Cypress)
5. **frontend-performance-auditor** - Frontend performance analysis (Lighthouse,
   Core Web Vitals)
...
**Author**: Claude Code Toolkit **Standard**: Anthropic Agent Skills
(December 2025) **Powered by**: Claude Sonnet 4.5
